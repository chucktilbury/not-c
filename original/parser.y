 ...
 *
 * In 1985, Jeff Lee published his Yacc grammar based on a draft version of the
 * ANSI C standard, along with a supporting Lex specification. Tom Stockfisch
 * reposted those files to net.sources in 1987; as mentioned in the answer to
 * question 17.25 of the comp.lang.c FAQ, they used to be available from
 * ftp.uu.net as usenet/net.sources/ansi.c.grammar.Z.
 *
 ...
 *
 * Downloaded on July 22, 2021 from
